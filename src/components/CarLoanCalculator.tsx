      ...
      <CardContent className="p-6">
        <div className="space-y-6">
          ...
          <div className="text-sm text-muted-foreground space-y-2 border-t pt-4">
            <h3 className="font-medium text-foreground">About Car Loans</h3>
            <p>
              A car loan is a type of installment loan used to purchase a vehicle. The lender pays for the car upfront, 
              and you repay the loan over time with interest. The monthly payment includes both principal and interest.
            </p>
            <p>
              The down payment is the initial upfront payment you make when purchasing a car. A larger down payment 
